...
internal class Program
{
    ...
    {
        // check employee wage within a 30 working days collection

        int Emp_rate_hour = 30, Emphrs = 0, Employeewage = 0, Day, Totalemployeewage = 0, Totalworkingdays = 0, Total_working_hour = 0;    // Defining the varialbles we use in this code 
        for (Day = 1; Day <= 30; Day++)                      // we apply for loop  to execuate until condition is false 
        {
